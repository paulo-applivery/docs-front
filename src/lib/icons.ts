export const iconMap = {
  ...
  // Missing keys used by Sidebar.astro
  bold: 'solar:text-bold-linear',
  italic: 'solar:text-italic-linear',
  underline: 'solar:text-underline-linear',
  strikethrough: 'solar:text-strikethrough-linear',
  quote: 'solar:quote-linear',
  redo: 'solar:forward-linear',
  undo: 'solar:backward-linear',
  ...
  nfc: 'solar:round-transfer-horizontal-linear',
  radio: 'solar:radio-minimalistic-linear',
